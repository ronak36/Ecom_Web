...
<tr><td><button id="ubtn${product.productId}" onclick="updateProduct('${product.productId}','${product.categoryId}')">Update</button></td>
<td><button id="dbtn${product.productId}" onclick="deleteProduct('${product.productId}','${product.categoryId}')">Delete</button></td></tr>
<tr><td></td><td></td></tr>
</table>
</c:forEach>
<form id="productForm">
